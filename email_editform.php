...
// if (isset($_POST['inputName']) && isset($_POST['inputEmail']) && isset($_POST['inputSubject']) && isset($_POST['inputMessage'])) {
    ...
    $mail->addStringAttachment(file_get_contents($_POST['pdfurl']),'hahahaha.pdf');
    $mail->isHTML(true);


    $mail->Subject = "BreadTopExpress Order #" . $_POST['invoiceNo'] . " has been UPDATED";
    $mail->Body    = "- Date: " . $_POST['invoiceEditDate'] . "<br>" .
                     "- To: " . $_POST['email'] . "<br>" .
